...
function BolaDaVez() {
  return (
    <section className="BolaDaVez">
      <div className="container boladavez-wrapper">
        ...
        <div className="blue-box">
          <p className="container">
            ...
            estarem focadas em um objetivo: o sucesso dos seus clientes. 
            <br/>
            <br/>
            Diariamente surgem uma novas vagas no mercado na área de Customer 
            Success e uma das maiores dificuldades dos recrutadores é a mão de 
            obra qualificada. Gente que entende da metodologia e sabe como 
            aplicar no seu dia a dia. Uma profissão que vale ouro no mercado.
          </p>
        </div>
      </div>
